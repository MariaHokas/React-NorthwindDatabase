...
class NWProductEdit extends Component {
    ...
    callBackRoutine() {
        console.log('NWTuoterEDIT: . . . . callBackRoutine >>>---' + this.state.tuoteObj.ProductID);
    }

    componentDidMount() {
        console.log("NWTuoteEDIT-componentDidMount this.props.tuoteObj.ProductID: " + this.props.tuoteObj.productId);
        this.setState({
        ...
        render() {
                return (
                    ...
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <RadioButton Discontinued={this.state.Discontinued} value={this.state.Discontinued} onChangeValue={this.handleChangeDiscontinued} />
